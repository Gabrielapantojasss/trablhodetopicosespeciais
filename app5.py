...
# playlists (o nome e as músicas relacionadas) no banco de dados do exercício 3.
# Na inclusão de músicas, o programa só deve permitir inserir na tabela “Playlist” números de músicas que constarem da
# tabela “Musicas”.
